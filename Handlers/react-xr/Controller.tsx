...
import { useXR, XRController, ControllersProps, Ray } from '@react-three/xr'
import { } from '@react-three/xr/src/XRControllerModel'
import { XRControllerModelFactory } from '@react-three/xr/src/XRControllerModelFactory'
import { XRControllerModel } from '@react-three/xr/src/XRControllerModel'
    ...
    <>
      {controllers.map((target, i) => (
        <React.Fragment key={i}>
          ...
          {createPortal(
            <Ray visible={true} hideOnBlur={hideRaysOnBlur} target={target} {...rayMaterialProps} />,
            target.controller
          )}
        </React.Fragment>
      ))}
